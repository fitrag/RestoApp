<div :class="open ? 'w-64' : 'w-20'" class="bg-gradient-to-b from-orange-500 to-orange-600 text-white shadow-lg transition-all duration-300 ease-in-out rounded-r-3xl">
    ...
    <div class="flex justify-between items-center p-6 border-b border-orange-400">
        <h1 x-show="open" class="text-xl font-bold tracking-wider">Fintory</h1>
    ...
    <div class="p-4 overflow-y-auto">
        ...
        <div class="mb-8">
            ...
            <nav class="space-y-2">
                ...
                <!-- Kategori Menu -->
                <a href="{{ route('kategori-menu') }}" 
                   class="flex items-center space-x-3 p-3 rounded-lg transition-colors {{ request()->routeIs('kategori-menu') ? 'bg-orange-400 text-black' : 'hover:bg-orange-400 hover:text-black' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="{{ route('list-menu') }}" 
                   class="flex items-center space-x-3 p-3 rounded-lg transition-colors {{ request()->routeIs('list-menu') ? 'bg-orange-400 text-black' : 'hover:bg-orange-400 hover:text-black' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <!-- Kupon Diskon -->
                <a href="#" 
                   class="flex items-center space-x-3 p-3 rounded-lg transition-colors {{ request()->routeIs('kupon-diskon') ? 'bg-orange-400 text-black' : 'hover:bg-orange-400 hover:text-black' }}">
